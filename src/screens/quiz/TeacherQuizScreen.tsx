...
const TeacherQuizScreen = ({ navigation }: any) => {
  ...
  const openManage = (chapter: SyllabusChapter, topic: SyllabusTopic) =>
              ...
              <View style={s.cardTop}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={s.cardSubtitle} numberOfLines={1}>
                    Tap a topic to manage its quizzes
                  </Text>
                </View>
            ...
            <View style={s.cardInner}>
              <View style={s.cardTop}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={s.cardSubtitle}>Add, edit or preview MCQs per topic</Text>
                </View>
              </View>
              ...
              {chaptersLoading ? (
                ...
                <View style={s.empty}>
                  ...
                  <Text style={s.emptySubText}>Add chapters & topics from the Syllabus screen first.</Text>
                </View>
              ) : (
                          ...
                          {chapter.topics.length === 0 ? (
                            ...
                            chapter.topics.map((topic, ti) => (
                              <TouchableOpacity
                                ...
                                onPress={() => openManage(chapter, topic)}
                                activeOpacity={0.7}
                              >
